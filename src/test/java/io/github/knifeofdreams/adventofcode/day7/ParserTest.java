...
class ParserTest {
  ...
  @Test
  public void sumOfTotalSizesForMyInput() {
    List<String> commands = Arrays.stream("""
                          $ ls
                          282959 btm
                          dir fmfnpm
                          dir gwlwp
            ...
            """.split("\n"))
        .map(String::trim)
            .filter(str -> !str.startsWith("$ ls") && !str.startsWith("dir "))
    ...
    var parser = new Parser();
    assertEquals(1491614, parser.sumOfAllsizes(rootNode));
  }

  @Test
  public void folderToDelete() {
    var rootNode =
        createTree(
            List.of(
                "14848514 b.txt",
                ...
                "7214296 k"));
    var parser = new Parser();
    assertEquals(24933642, parser.folderToDelete(rootNode));
  }

  @Test
  public void folderToDeleteForMyInput() {
    List<String> commands = Arrays.stream("""
                          $ ls
                          282959 btm
                          dir fmfnpm
    ...
    var parser = new Parser();
    assertEquals(6400111, parser.folderToDelete(rootNode));
  }
